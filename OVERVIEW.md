...
```bash
# Install the core SDK dependency (just PyYAML for now)
pip install pyyaml

# OR install as a full package (includes all optional framework deps)
...
```bash
python sdk/cli.py info examples/summarize-document/skill.yaml
```
